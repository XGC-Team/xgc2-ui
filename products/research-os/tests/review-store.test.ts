...
describe('F3 review routing in the real Zustand store',()=>{
 beforeEach(()=>{useWorkbench.setState({rightTabs:[],activeRightTab:'',reviewIntents:[],reviewFocus:null,projectId:'other-project'})})
 ...
 it('captures an immutable versioned feedback object without sending a chat prompt',()=>{
