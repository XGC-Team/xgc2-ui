...
export function Sidebar({projects,onRefresh,loading,error}:{projects:Project[];onRefresh:()=>void;loading:boolean;error:string}) {
 const {activeNav,setActiveNav,projectId,setProjectId,openRightTab,openCanvas}=useWorkbench();const native=useNativeAgentSession()
