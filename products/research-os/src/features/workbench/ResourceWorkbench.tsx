...
import { ArrowLeft, ArrowLeftToLine, ArrowRightToLine, BookOpen, Columns3, FileCode2, FileText, Folder, Globe, Layers, MessageSquare, Waypoints, Network, PictureInPicture2, X } from 'lucide-react'
...
const icons = { chat: MessageSquare, research: Network, source: FileCode2, original: FileText, reviews: FileText, drafts: FileText, web: Globe, file: Folder, pdf: FileText, note: BookOpen, artifacts: Layers, argument: Waypoints }
